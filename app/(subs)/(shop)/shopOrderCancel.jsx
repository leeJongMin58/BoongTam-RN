    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.headerTitle}>{STRINGS.BOONG_TAM.ORDER.BOONG_TEM_ORDER_CURRENT}</Text>
            </View>
            ...
            <View style={styles.content}>
                ...
                <TouchableOpacity style={styles.button} onPress={handleGoToMain}>
                    <Text style={styles.buttonText}>{STRINGS.BOONG_TAM.INFO.GO_BOONGTEM}</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
